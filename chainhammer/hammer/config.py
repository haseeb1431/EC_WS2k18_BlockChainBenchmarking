...
RPCaddress, RPCaddress2 = 'http://172.31.23.253:8501', 'http://172.31.23.253:8501' # crux dockerized, see https://github.com/blk-io/crux/blob/master/README.md#4-node-quorum-network-with-crux
#RPCaddress, RPCaddress2 = 'http://3.91.81.110:8501', 'http://3.91.81.110:8501'  # orbita-center_parity-poa-playground; parity-deploy

#RPCaddress, RPCaddress2 = 'http://18.195.17.6:8501', 'http://18.195.17.6:8501'  # javahippie_geth-dev; use two different nodes for writing and reading  
